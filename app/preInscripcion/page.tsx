      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-10 w-full h-auto flex sm:justify-center flex-wrap gap-8">
          ...
          <div className='w-fit h-auto text-gray-900 font-semibold flex flex-col' >
            ...
            <Link className='hover:text-center'  href={"https://docs.google.com/forms/d/e/1FAIpQLSfcs9dWHrES_UcJ8H2p1O0HiaYvOJPKy5v0YQ9n-zpLF8V6-w/closedform"} >Pauta Publicitaria</Link>
